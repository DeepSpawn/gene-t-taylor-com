...
![Illustration of an IBM System/370 configuration — central processor and console, tape and disk storage, and card equipment, with operators at their consoles](../../assets/end-of-code-review/ibm-system-370.png)

IT professionals, at least at IBM, looked something like:
![IBM staff in dark suits and ties reviewing page proofs of IBM News, 1972](../../assets/end-of-code-review/ibm-news-1972-professionals.png#medium)
...
![Opening paragraph of the paper, with the thesis highlighted: managing a process requires planning, measurement, and control](../../assets/end-of-code-review/fagan-paper-intro-highlighted.png)
...
![Fagan Table 3 — the inspection process operations, their rate of progress, and the objective of each](../../assets/end-of-code-review/fagan-table3-inspection-rate-of-progress.png)
...
![Figure 11, new approach — inspections give a first quantitative indication of quality far earlier](../../assets/end-of-code-review/fagan-fig11-process-management-new.png)
...
![Highlighted quote: purging errors early is 10 to 100 times less expensive than late rework](../../assets/end-of-code-review/fagan-quote-purging-errors-cost.png#medium)
...
![Fagan: approximately two thirds of all errors reported during development are found by I₁ and I₂ inspections prior to machine testing](../../assets/end-of-code-review/fagan-quote-two-thirds-before-testing.png#medium)
...
![Figure 7B — an example code inspection report / module detail form](../../assets/end-of-code-review/fagan-fig7b-code-inspection-report.png)
...
![The I1 logic checklist, grouped into Missing, Wrong, and Extra categories](../../assets/end-of-code-review/fagan-i1-logic-checklist.png)
...
![Figure B — the feedback and feed-forward loops that make inspection a learning process](../../assets/end-of-code-review/fagan-figB-feedback-feedforward.png)
...
![The paper's summary — a numbered list of steps for running design and code inspections with process control](../../assets/end-of-code-review/fagan-summary.png)
